...
- Creates a Customer Gateway (CGW) pointing to the provided firewall IP on the on-premises network
- Creates a Virtual Private Gateway (VPG) and attaches it to the VPC
- Creates a Site-to-Site Virtual Private Network (VPN) connection and assign it to the VPG and CGW
- Adds the routes for the provided IP ranges you will need to access on the network and select the CGW as its target
...
```hcl
module "terraform-aws-vpn-connection" {
...
[![Beacon][beacon]][website]
  ...
  [readme_header_img]: https://cloudposse.com/readme/header/img?repo=cloudposse/terraform-aws-vpn-connection
  [readme_header_link]: https://cloudposse.com/readme/header/link?repo=cloudposse/terraform-aws-vpn-connection
  [readme_footer_img]: https://cloudposse.com/readme/footer/img?repo=cloudposse/terraform-aws-vpn-connection
  [readme_footer_link]: https://cloudposse.com/readme/footer/link?repo=cloudposse/terraform-aws-vpn-connection
  [readme_commercial_support_img]: https://cloudposse.com/readme/commercial-support/img?repo=cloudposse/terraform-aws-vpn-connection
  [readme_commercial_support_link]: https://cloudposse.com/readme/commercial-support/link?repo=cloudposse/terraform-aws-vpn-connection
