...
| <a name="input_customer_gateway_device_name"></a> [customer\_gateway\_device\_name](#input\_customer\_gateway\_device\_name) | The Device Name of the Customer Gateway | `string` | `""` | no |
...
| <a name="input_enable_acceleration"></a> [enable\_acceleration](#input\_enable\_acceleration) | Set to true to enable VPN connection acceleration. Available only for VPN connections that use transit gateway. | `bool` | `false` | no |
